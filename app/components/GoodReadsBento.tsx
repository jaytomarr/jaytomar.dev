...
export function GoodReadsBento({ linkTo }: { linkTo?: string }) {
  return (
    <BentoCard
    ...
    >
      <div className="group flex h-full flex-col md:flex-row">
        <div className="flex-1 text-balance md:pr-4">
          <h2 className="mb-4 text-base font-medium">Good Reads</h2>
          <p className="mb-2 text-balance text-sm text-text-secondary md:text-base">
            The books that made me question my life choices at 3 AM.
          </p>
        </div>

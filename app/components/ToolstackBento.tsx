import { developmentData } from "../data/toolstackData";
import { BentoCard } from "./BentoCard";
import Image from "next/image";

// Reorder to put Flutter in 3rd position (index 2)
const reorderedData = [
  developmentData[8],
  developmentData[1],
  developmentData[0],
...
export function ToolstackBento({ linkTo }: { linkTo?: string }) {
  return (
    <BentoCard linkTo={linkTo} height="md:h-[304px] lg:h-[300px]">
      ...
      <div className="z-20 text-center">
        <h2 className="text-base font-medium">Toolstack</h2>

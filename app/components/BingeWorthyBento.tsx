...
export function BingeWorthyBento({ linkTo }: { linkTo?: string }) {
  return (
    <BentoCard
    ...
    >
      <div className="group flex h-full flex-col md:flex-row">
        <div className="flex-1 text-balance md:pr-4">
          <h2 className="mb-4 text-base font-medium">Binge Worthy</h2>
          <p className="mb-2 text-sm text-text-secondary md:text-base">

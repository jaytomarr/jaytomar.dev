    ...
    <div className="relative">
      ...
      <div className="relative space-y-10 md:space-y-16">
        <div className="mx-auto text-balance pt-14 md:pt-16">
          <GridWrapper>
            <h1 className="mx-auto max-w-2xl text-center text-3xl font-medium leading-tight tracking-tighter text-text-primary md:text-6xl md:leading-[56px]">
        ...
        <GridWrapper>
          <div className="relative grid grid-cols-3 place-items-center justify-items-center gap-y-8 md:grid-cols-4 lg:grid-cols-6 lg:gap-6">
        ...
        <GridWrapper>
          <div className="relative grid grid-cols-3 place-items-center justify-items-center gap-y-8 md:grid-cols-4 lg:grid-cols-7 lg:gap-6">
        ...
        <GridWrapper>
          <div className="relative grid grid-cols-3 place-items-center justify-items-center gap-y-8 md:grid-cols-4 lg:grid-cols-5 lg:gap-6">
            {designData.map((item) => (
              <a
                key={item.title}
                href={item.link}
